...
public class ConnDB {
	...
	private static EntityManagerFactory getEntityManagerFactory() {
		if (entityManagerFactory == null)
			entityManagerFactory = Persistence.createEntityManagerFactory("fatflix");
	...
	private static List<String> consultAPI() {
		...
		try {
			...
			Alert alert = AlertUtil.error("Error", "Not able to connect to the API", "Error trying accessing the API", e);
			alert.showAndWait();
		}
		return result;
	}
